...
#maxv(2).
#modeh(forecasted_sky(const(location),const(coverage),const(possible_season))).
#modeh(forecasted_rain(const(location),const(rain_lvs),const(possible_season))).

#modeb(not_city_covered_at_least_morning_neighbour(const(location),const(lv))).
#modeb(not_city_covered_at_least_afternoon_neighbour(const(location),const(lv))).
#modeb(city_covered_at_least_afternoon_neighbour(const(location),const(lv))).
#modeb(city_covered_at_least_morning_neighbour(const(location),const(lv))).
#modeb(city_covered_exactly_afternoon_neighbour(const(location),const(lv))).
#modeb(city_covered_exactly_morning_neighbour(const(location),const(lv))).
#modeb(city_covered_less_than_neighbour(const(location),const(lv))).
#modeb(temperature_increased_at_afternoon_neighbour(const(location))).
#modeb(temperature_decreased_at_afternoon_neighbour(const(location))).
#modeb(humidity_increased_at_afternoon_neighbour(const(location))).
#modeb(humidity_decreased_at_afternoon_neighbour(const(location))).
#modeb(wind_blowing_morning_neighbour(const(location),const(wind_dir))).
#modeb(wind_blowing_afternoon_neighbour(const(location),const(wind_dir))).
#modeb(not_city_covered_less_than_neighbour(const(location),const(lv))).



#modeb(wind_blowing_morning_speed(const(location),num_var(wind_speed_level))).
#modeb(wind_blowing_afternoon_speed(const(location),num_var(wind_speed_level))). 

#modeb(wind_blowing_morning_neighbour_speed(const(location),num_var(wind_speed_level))).
#modeb(wind_blowing_afternoon_neighbour_speed(const(location),num_var(wind_speed_level))).


#modeb(not_city_covered_at_least_morning_(const(location),const(lv))).
#modeb(not_city_covered_at_least_afternoon_(const(location),const(lv))).
#modeb(city_covered_at_least_afternoon_(const(location),const(lv))).
#modeb(city_covered_at_least_morning_(const(location),const(lv))).
#modeb(city_covered_exactly_afternoon_(const(location),const(lv))).
#modeb(city_covered_exactly_morning_(const(location),const(lv))).
#modeb(city_covered_less_than_(const(location),const(lv))).
#modeb(temperature_increased_at_afternoon_(const(location))).
#modeb(temperature_decreased_at_afternoon_(const(location))).
#modeb(humidity_increased_at_afternoon_(const(location))).
#modeb(humidity_decreased_at_afternoon_(const(location))).
#modeb(wind_blowing_morning_(const(location),const(wind_dir))).
#modeb(wind_blowing_afternoon_(const(location),const(wind_dir))).
#modeb(not_city_covered_less_than_(const(location),const(lv))).

#modeb(temp_front_afternoon_at_1000hPa(const(location),const(location))).
#modeb(temp_front_afternoon_at_850hPa(const(location),const(location))). 
#modeb(temp_front_afternoon_at_500hPa(const(location),const(location))). 
#modeb(temp_front_afternoon_at_925hPa(const(location),const(location))). 
#modeb(temp_front_afternoon_at_700hPa(const(location),const(location))).
#modeb(temp_front_afternoon_at_300hPa(const(location),const(location))). 

#modeb(temp_front_morning_at_1000hPa(const(location),const(location))). 
#modeb(temp_front_morning_at_850hPa(const(location),const(location))). 
#modeb(temp_front_morning_at_500hPa(const(location),const(location))).
#modeb(temp_front_morning_at_925hPa(const(location),const(location))). 
#modeb(temp_front_morning_at_700hPa(const(location),const(location))). 
#modeb(temp_front_morning_at_300hPa(const(location),const(location))).

#modeb(hum_front_afternoon_at_1000hPa(const(location),const(location))).
#modeb(hum_front_afternoon_at_850hPa(const(location),const(location))). 
#modeb(hum_front_afternoon_at_500hPa(const(location),const(location))). 
#modeb(hum_front_afternoon_at_925hPa(const(location),const(location))). 
#modeb(hum_front_afternoon_at_700hPa(const(location),const(location))).
#modeb(hum_front_afternoon_at_300hPa(const(location),const(location))). 

#modeb(hum_front_morning_at_1000hPa(const(location),const(location))). 
#modeb(hum_front_morning_at_850hPa(const(location),const(location))). 
#modeb(hum_front_morning_at_500hPa(const(location),const(location))).
#modeb(hum_front_morning_at_925hPa(const(location),const(location))). 
#modeb(hum_front_morning_at_700hPa(const(location),const(location))). 
#modeb(hum_front_morning_at_300hPa(const(location),const(location))).

#modeb(season(const(possible_season))).

#bias("penalty(2, body(X)) :- in_body(X).").

%#bias(":- in_body(wind_blowing_morning_(_,_,Y)), not cond(Y).").
%#bias(":- in_body(wind_blowing_afternoon_(_,_,Y)), not cond(Y).").
%#bias(":- in_body(wind_blowing_morning_neighbour(_,_,Y)), not cond(Y).").
%#bias(":- in_body(wind_blowing_afternoon_neighbour(_,_,Y)), not cond(Y).").

#bias(":- in_body(wind_blowing_afternoon_neighbour_speed(_,Y)), not cond(Y).").
#bias(":- in_body(wind_blowing_morning_neighbour_speed(_,Y)), not cond(Y).").

#bias(":- in_body(wind_blowing_afternoon_speed(_,Y)), not cond(Y).").
#bias(":- in_body(wind_blowing_morning_speed(_,Y)), not cond(Y).").


#bias(":- not in_body(not_city_covered_at_least_morning_(_,_)), not in_body(city_covered_at_least_morning_(_,_)), not in_body(not_city_covered_at_least_afternoon_(_,_)), not in_body(city_covered_at_least_afternoon_(_,_)), not in_body(city_covered_less_than_(_,_)), not in_body(not_city_covered_less_than_(_,_)).").

#bias("penalty(2, not_city_covered_at_least_morning_neighbour(X,Y))   :- in_body(not_city_covered_at_least_morning_neighbour(X,Y)).").
#bias("penalty(2, not_city_covered_at_least_afternoon_neighbour(X,Y))   :- in_body(not_city_covered_at_least_afternoon_neighbour(X,Y)).").
#bias("penalty(2, city_covered_at_least_afternoon_neighbour(X,Y)) :- in_body(city_covered_at_least_afternoon_neighbour(X,Y)).").
#bias("penalty(2, city_covered_at_least_morning_neighbour(X,Y)) :- in_body(city_covered_at_least_morning_neighbour(X,Y)).").
#bias("penalty(2, city_covered_exactly_afternoon_neighbour(X,Y)) :- in_body(city_covered_exactly_afternoon_neighbour(X,Y)).").
#bias("penalty(2, city_covered_exactly_morning_neighbour(X,Y))   :- in_body(city_covered_exactly_morning_neighbour(X,Y)).").
#bias("penalty(2, city_covered_less_than_neighbour(X,Y))   :- in_body(city_covered_less_than_neighbour(X,Y)).").
#bias("penalty(2, temperature_increased_at_afternoon_neighbour(X)) :- in_body(temperature_increased_at_afternoon_neighbour(X)).").
#bias("penalty(2, temperature_decreased_at_afternoon_neighbour(X)) :- in_body(temperature_decreased_at_afternoon_neighbour(X)).").
#bias("penalty(2, humidity_increased_at_afternoon_neighbour(X)) :- in_body(humidity_increased_at_afternoon_neighbour(X)).").
#bias("penalty(2, humidity_decreased_at_afternoon_neighbour(X)) :- in_body(humidity_decreased_at_afternoon_neighbour(X)).").
#bias("penalty(1, wind_blowing_morning_neighbour(X,Y))     :- in_body(wind_blowing_morning_neighbour(X,Y)).").
#bias("penalty(1, wind_blowing_afternoon_neighbour(X,Y))     :- in_body(wind_blowing_afternoon_neighbour(X,Y)).").
#bias("penalty(1, wind_blowing_morning_neighbour_speed(X,Y))     :- in_body(wind_blowing_morning_neighbour_speed(X,Y)).").
#bias("penalty(1, wind_blowing_afternoon_neighbour_speed(X,Y))     :- in_body(wind_blowing_afternoon_neighbour_speed(X,Y)).").
#bias("penalty(2, not_city_covered_less_than_neighbour(X,Y))  :- in_body(not_city_covered_less_than_neighbour(X,Y)).").