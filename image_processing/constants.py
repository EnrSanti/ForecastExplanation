...
DEFAULT_V_MAX_AT_HEIGHT = {"_at_100m":20, "_at_750m":25, "_at_1_4km":25, "_at_3km":35, "_at_5_5km":45, "_at_9km":70}
DEFAULT_DXY = 2500
DEFAULT_DT = 3600
...
class WeatherPhenomenonTobacParams(Enum):
    TEMPERATURE = {"min_blob_size": 800, "target": "maximum", "smooth": 8, "threshold": 0.6 , "cmap": "OrRd"}
    HUMIDITY = {"min_blob_size": 800, "target": "minimum", "smooth": 8, "threshold": 0.65, "cmap": "YlGnBu"}
    CLOUDS = {"min_blob_size": 500, "target": "maximum", "smooth": 8, "threshold": 0.65, "cmap": "viridis"}
    WIND = {"min_blob_size": 500, "target": "maximum", "smooth": 8, "threshold": 0.6, "cmap": "viridis"}
